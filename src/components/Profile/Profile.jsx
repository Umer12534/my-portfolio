        ...
        <div className="profile-top-row">
          ...
          <div className="profile-about">
            ...
            <p className="profile-about__text">
              Experienced in building modern web applications using frontend and
              backend technologies. Passionate about creating scalable solutions
              and currently expanding expertise in Artificial Intelligence and
              Robotics to develop intelligent, real-world systems.
            </p>
          </div>
        </div>
            ...
            <div className="skills-column">
              <div className="skill-category">
                <div className="skill-category__header">
                  ...
                  <span className="skill-category__title">
                    Tools & Technologies
                  </span>
                </div>
                {TOOLS.map((tool, idx) => (
